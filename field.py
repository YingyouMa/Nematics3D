...
def visualize_nematics_field(n=[0], S=[0], defect_indices=None,
                             ...
                             n_is_colorbar=True, n_colorbar_params={}, n_colorbar_range='default',
                             S_threshold=0.45, S_opacity=1, S_plot_params={},
                             S_is_colorbar=True, S_colorbar_params={}, S_colorbar_range=(0,1),
                             ...
                             new_figure=True, bgcolor=(1,1,1), fgcolor=(0,0,0), figsize=(1920, 1360), is_axes=False, 
                             defect_n_opacity=-1, n_is_color_immerse=False
                             ):
    ...
    if plotn:
        ...
        vector, n_color_scalars, scalars = make_plot_directors(n_order_ind, 
                                                               n_opacity=n_opacity, n_is_color_immerse=n_is_color_immerse)

        if np.size(n_defect_ind)>1:
            make_plot_directors(n_defect_ind, 
                                n_opacity=defect_n_opacity, n_is_color_immerse=n_is_color_immerse)
