...
class InteractSphere(PanelBase):
    def __init__(self, host, figure):
        super().__init__(host, figure, title=f"Sphere Controls of {host.name!r}")
    ...
    def build_ui(self):
        ...
        self.chk_use_color.setChecked(bool(self.state["is_use_control_color"]))
        ...
        self.chk_use_opacity.setChecked(bool(self.state["is_use_control_opacity"]))
