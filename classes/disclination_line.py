...
class InputLine:
    ...
    _validators = {
        "defect_indices":               lambda v, d: None if v is None else as_DefectIndex(v, is_return_row=True),
    ...
    def _helper_get_coords(self, logger=None):
        ...
        if not self.state_is_wrap:
            ...
            if self.owner.owner._calc_end2end_kind == "loop":
                logger.detail(f'Line {self.owner.name!r} is a loop. Closing the loop by appending the start point to the end.')
