...
class DisclinationLine(ClassBase):
    ...
    __descriptions__ = {
        **(ClassBase.__descriptions__),
        ...
        "_calc_norm":                       "Property: Estimated average plane normal vector of the disclination line (3-vector)",
    ...
    def _calc_norm(self, logger=None) -> np.ndarray:
        """
        Property: Calculates the best-fit plane normal for the disclination line.
        """
