...
from .interpolate_plane_polar import InterpolatePlanePolar


class QPlanePolar(InterpolatePlanePolar):

    __descriptions__ = {
        **(InterpolatePlanePolar.__descriptions__),
    ...
    __slots__ = tuple(
            ...
            if not v.startswith("Property:") and k not in InterpolatePlanePolar.__slots__
        )
    ...
    def _helper_commit(self, logger=None):
        ...
        Q_all = self._raw_interpolator.interpolate(self._entity_plane._entity_grid_all)
        ...
        defect_centers, adjacent_mask = self._helper_detect_defects(n_all)
        ...
        if len(defect_centers) == 0:
            ...
            object.__setattr__(self, '_calc_defect_pos', defect_centers)
