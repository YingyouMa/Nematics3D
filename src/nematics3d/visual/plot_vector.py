...
class PlotVector(PlotGlyph):
    ...
    Each vector is rendered as a cylindrical shaft plus a cone-like tip. The
    total display length and shaft radius support the standard glyph resolver
    model, while tip dimensions are derived from the configured length and
    radius ratios.
    """
