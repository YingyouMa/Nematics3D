...
class ScalarBar(HostBase):
    ...
    __attr_defs__ = {
        ...
        "entity_mapper_adapter": AttrDef(
            doc=(
                "Persistent PyVista mapper adapter used when the source renderer "
                "exposes only a raw VTK mapper API."
            ),
            kind="entity",
        ),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        object.__setattr__(self, "raw_mapper_name", mapper_name_validated)
        ...
        object.__setattr__(self, "entity_mapper_adapter", None)
    ...
    def _helper_set_mapper_adapter(self, mapper):
        """Attach or replace the persistent mapper adapter for this scalar bar."""
        object.__setattr__(self, "entity_mapper_adapter", mapper)
        return mapper
