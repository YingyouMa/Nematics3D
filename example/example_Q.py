...
# testGrid = Nematics3D.PlaneGrid(normal=(1,1,1), spacing=spacing, size=100, origin=(index_max/2-trans,index_max/2-trans,index_max/2-trans), bounds=Q._calc_corners)
...
# testPolarGrid = Nematics3D.PlaneGridPolar(normal=(1,1,1), dr=2.5, R_max=36, origin=origin, bounds=Q._calc_corners)
