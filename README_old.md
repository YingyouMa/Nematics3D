...
Python 3.11 is currently supported for packaging and installation. The current tested version is:
 - **Python**:      3.11.7
...
# Then modify the figure. You could do this on command line to gradually adjust parameters to find the best values.
...
trans = 7.5 # translate the plane a little bit
